...
import { configDFMApproverApplication } from "../config";
  ...
  const { isLoading: financialYearsLoading, data: financialYearsData } = Digit.Hooks.pt.useMDMS(
    ...
    {},
    {
      details: {
        ...
        moduleDetails: [{ moduleName: "egf-master", masterDetails: [{ name: "FinancialYear", filter: "[?(@.module == 'egov-filemgmnt')]" }] }],
      },
    }
  );
