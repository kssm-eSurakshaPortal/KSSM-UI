...
const BirthMotherInformation = ({ config, onSelect, userType, formData }) => {
  ...
  const [MotherFirstNameEn, setMotherFirstNameEn] = useState(formData?.BirthMotherInfoDetails?.MotherFirstNameEn);
  const [MotherMiddleNameEn, setMotherMiddleNameEn] = useState(formData?.BirthMotherInfoDetails?.MotherMiddleNameEn);
  const [MotherLastNameEn, setMotherLastNameEn] = useState(formData?.BirthMotherInfoDetails?.MotherLastNameEn);
//   const [MotherFirstNameMl, setMotherFirstNameMl] = useState(formData?.BirthMotherInfoDetails?.MotherFirstNameMl);
//   const [MotherMiddleNameMl, setMotherMiddleNameMl] = useState(formData?.BirthMotherInfoDetails?.MotherMiddleNameMl);
//   const [MotherLastNameMl, setMotherLastNameMl] = useState(formData?.BirthMotherInfoDetails?.MotherLotherPlaceNameastNameMl);
  const [MotherAadhar, setMotherAadhar] = useState(formData?.BirthMotherInfoDetails?.MotherAadhar);
  const [MotherPassportNo, setMotherPassportNo] = useState(formData?.BirthMotherInfoDetails?.MotherPassportNo);
  const [MotherEmail, setMotherEmail] = useState(formData?.BirthMotherInfoDetails?.MotherEmail);
  const [MotherMobile, setMotherMobile] = useState(formData?.BirthMotherInfoDetails?.MotherMobile);
  const [MotherEducation, setMotherEducation] = useState(formData?.BirthMotherInfoDetails?.MotherEducation);
  // const [MotherEducationSubject, setMotherEducationSubject] = useState(formData?.BirthMotherInfoDetails?.MotherEducationSubject);
  const [MotherProfession, setMotherProfession] = useState(formData?.BirthMotherInfoDetails?.MotherProfession);
  const [LBTypeName, setLBTypeName] = useState(formData?.BirthMotherInfoDetails?.LBTypeName);
  const [StateName, setStateName] = useState(formData?.BirthMotherInfoDetails?.StateName);
  const [MotherDistrict, setMotherDistrict] = useState(formData?.BirthMotherInfoDetails?.MotherDistrict);   
  const [MotherNationality, setMotherNationality] = useState(formData?.BirthMotherInfoDetails?.MotherNationality);  
        ...
        <div className="row">
          <div className="col-md-12">
            <h1 className="headingh1">
              <span style={{ background: "#fff", padding: "0 10px" }}>{`${t("CR_BIRTH_MOTHER_INFORMATION")}`}</span>{" "}
            </h1>
          </div>
        </div>
        <div className="row">
